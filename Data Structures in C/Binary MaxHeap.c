...
{
    printf("----------------MENU----------------\n");
    printf("1.Insert an element into the Max Heap\n");
    printf("2.Delete given element from the Max Heap\n");
    printf("3.Delete the maximum element from the Max Heap\n");
    printf("4.Print the maximum element in the Max Heap\n");
    printf("5.Check if the Max Heap is empty\n");
    printf("6.Exit\n");
    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case 4:if(empty(&h))
                        ...
                        printf("Maximum in the heap is %d\n\n",maximum(&h));
                    break;
            case 5:if(empty(&h))
