...
{
    printf("----------------MENU----------------\n");
    printf("1.Insert an element into the AVL Tree\n");
    printf("2.Delete an element from the AVL Tree\n");
    printf("3.Print the traversals on the AVL Tree\n");
    printf("4.Check if an element is present in the AVL Tree\n");
    printf("5.Print the maximum element in the AVL Tree\n");
    printf("6.Print the minimum element in the AVL Tree\n");
    printf("7.Exit\n");
...
void insert(AVL *tree,int ele)
{
    tree->root=insertNode(tree->root,ele);
    tree->size++;
    return;
}
...
void delete(AVL *tree,int ele)
{
    tree->root=deleteNode(tree->root,ele);
    tree->size--;
    return;
}
...
int* preorder(AVL tree,int *traversal)
{
    int size=0;
    stack s={NULL,0};
    treeNode* cur;
...
int* inorder(AVL tree,int* traversal)
{
    int size=0;
    stack s={NULL,0};
    treeNode* cur=tree.root;
...
int* postorder(AVL tree,int *traversal)
{
    int size=0;
    stack s={NULL,0};
    treeNode* cur=tree.root;
...
treeNode* search(AVL tree,int ele)
{
    treeNode* cur=tree.root;
    while(cur!=NULL)
    {
